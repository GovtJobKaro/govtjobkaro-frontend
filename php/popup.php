...
if(isset($_POST['mobile'])){
    ...
    $user_type = urlencode($_POST['user_type']);
    
    
    require_once 'link.php';
    // login api
    $url = $link.'/api/v1/popup_submit_number?full_name='.$name.'&mobile_no='.$mobile.'&user_type='.$user_type.'&device='.$from_browser.'&ip_address='.$from_ip.'&time='.$date_now.'';
    $request_url = $url ;
