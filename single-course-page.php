            ...
            <div class="container d-flex flex-column align-items-center justify-content-center course-details">
                ...
                <a class="checkout">
                    <button class="btn pink-btn poppins-regular">
                        Start Subscription For Just Rs. <span class="sale-price">700</span> / Month
                    </button>
                </a>
            </div>
        </div>
            ...
            for (const topics of video) {
                ...
                demo += `<div class="demo-video demo-video-${topic_id} d-flex align-items-center justify-content-between">
                                    <div class="demo-video-text">
                                        ...
                                        <div class="demo-video-stats d-flex justify-content-between">
                                            ...
                                            <div class="poppins-regular">
                                                <img loading="lazy" src="https://storage.googleapis.com/govtjobkaro_images/play-line.png" alt="image">
                                    ...
                                    <div>
                                        <span id="demo-${topic_id}" class="${topics.demo_src ? '' : 'invisible'} btn orange-btn poppins-regular">
                                        Watch Demo
                                        </span>
                                        <button id="btn-${topic_id}" class="btn-margin d-flex align-items-center justify-content-center mt-2" style=" margin-left: 70%;width:38px; height:38px; border: 1.5px solid #F68C20;background-color: transparent; outline:none;border-radius: .25rem;" type="button" data-toggle="collapse" data-target="#collapse-${topic_id}" aria-expanded="true" aria-controls="collapse-${topic_id}">
                                            <img class="down-arrow down-arrow-${topic_id}" src="https://storage.googleapis.com/govtjobkaro_images/arrow-down-s-line.png" alt="down button">
                                        </button>
                                    </div>
                                </div>
                ...
                sub_topicsArr.forEach(sub_topic => {
                    ...
                    demo += `<div class="accordion shadow-sm border-0" id="accordion-${module_id}">
                                <div class="border-0">
                                    <button id="sub-topic-name-${module_id}" class="btn text-left sub-topic-name poppins-medium" type="button" data-toggle="collapse" data-target="#sub-topic-${module_id}" aria-expanded="false"
                                    aria-controls="sub-topic-${module_id}">
                                        <p class="d-inline mb-0">${sub_topic.module_name}</p>
                                        <img style="margin-right: 8px;" class="down-arrow-${module_id} float-right" src="https://storage.googleapis.com/govtjobkaro_images/arrow-down-s-line.png" alt="down button">
                                    </button>
                                    <div id="sub-topic-${module_id}" class="collapse" aria-labelledby="sub-topic-name-${module_id}" data-parent="#accordion-${module_id}" ><!-- onpage-loader -->
                                        <div class="onpage-loader onpage-loader-${module_id}"style="min-height: 44px;">
                                            <div class="loader" style="width: 30px;height: 30px;border: 4px solid #f68c20; border-bottom-color: transparent;"></div>
                                        </div>
                                        </div></div></div>`;
                });
                ...
                demo += `</div>
                                <div id="popup-${topic_id}" class="d-none demo-popup">
                                    <div>
                                        <div class="shadow-lg">
                                            <div class="demo-title"><h5 class="poppins-medium">${topicName}</h5><img class="close-demo" src="https://storage.googleapis.com/govtjobkaro_images/close-circle-line.png" alt="close button"></div><video id="video-${topic_id}" class="video-demo video-js vjs-default-skin vjs-big-play-centered" controls  data-setup='{}'><source src="${topics.demo_src}" type='application/x-mpegURL' label='360p' res='360' /></video>
                                        </div>
                                    </div>
                                </div>`;
